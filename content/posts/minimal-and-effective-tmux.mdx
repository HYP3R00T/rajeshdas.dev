...
cover: "./cover/setup.png"
coverAlt: Default image
ogImage: "./og/setup.png"
...
<LinkPreview url="https://github.com/tmux/tmux/wiki" />
<LinkPreview url="https://github.com/HYP3R00T/.dotfiles/blob/main/configurations/.tmux.conf" />
