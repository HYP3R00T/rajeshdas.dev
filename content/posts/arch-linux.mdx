...
<LinkPreview url="https://wiki.archlinux.org/title/Fdisk" />
...
<LinkPreview url="https://www.man7.org/linux/man-pages/man8/lsblk.8.html" />
...
<LinkPreview url="https://wiki.archlinux.org/title/Dm-crypt/Encrypting_an_entire_system" />
...
<LinkPreview url="https://wiki.archlinux.org/title/Fstab" />
...
<LinkPreview url="https://wiki.archlinux.org/title/Chroot" />
...
<LinkPreview url="https://wiki.archlinux.org/title/System_time" />
...
<LinkPreview url="https://wiki.archlinux.org/title/Network_configuration" />
<LinkPreview url="https://wiki.archlinux.org/title/Systemd-networkd" />
<LinkPreview url="https://wiki.archlinux.org/title/Systemd-resolved" />
...
<LinkPreview url="https://wiki.archlinux.org/title/Iwd" />
...
<LinkPreview url="https://en.wikipedia.org/wiki/Initial_ramdisk" />
<LinkPreview url="https://wiki.archlinux.org/title/Mkinitcpio" />

For LVM, system encryption or RAID, modify `mkinitcpio.conf` and recreate the `initramfs` image

[Configuring mkinitcpio](https://wiki.archlinux.org/title/Dm-crypt/Encrypting_an_entire_system#Configuring_mkinitcpio)
...
<LinkPreview url="https://wiki.archlinux.org/title/Arch_boot_process" />
<LinkPreview url="https://wiki.archlinux.org/title/Systemd-boot" />
<LinkPreview url="https://man.archlinux.org/man/bootctl.1" />
