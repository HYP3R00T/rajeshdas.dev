...
category: Technology
cover: "./cover/exception-handling-in-python-a-detailed-guide.png"
coverAlt: Default image
ogImage: "./og/exception-handling-in-python-a-detailed-guide.png"
ogImageAlt: Default image
---

<iframe
  width="560"
  height="315"
  src="https://www.youtube.com/embed/zYW3f9kMwbA?controls=1&modestbranding=0&rel=0&showinfo=0"
